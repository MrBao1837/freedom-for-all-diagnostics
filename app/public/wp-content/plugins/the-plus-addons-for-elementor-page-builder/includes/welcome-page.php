		...
		echo '<div class="theplus-panel-col theplus-panel-col-65">';
			...
			echo '<div class="theplus-panel-sec theplus-p-20 theplus-welcome-changelog theplus-mb-8">';
				...
				echo '<div class="theplus-changelog-list">';
					echo '<div class="changelog-date">December 06, 2023 <span class="changelog-version">Lite Version 5.3.0</span></div>';
						echo '<ul class="changelog-list">';
							echo '<li>'.esc_html__('Fix : Info Box : Font Awesome 5 Icon Size not Working', 'tpebl').'</li>';
							echo '<li>'.esc_html__('Fix: Button : Style 2 css Improvement', 'tpebl').'</li>';
				...
				echo '<div class="theplus-changelog-list">';
					echo '<div class="changelog-date">December 06, 2023 <span class="changelog-version">Pro Version 5.3.0</span></div>';
						echo '<ul class="changelog-list">';	
							echo '<li>'.esc_html__('Add : Horizontal Scroll', 'tpebl').'</li>';
							echo '<li>'.esc_html__('Fix : Search Filter : Compatibility with category archive page', 'tpebl').'</li>';
							echo '<li>'.esc_html__('Fix : Minor bug fixes & Improvements', 'tpebl').'</li>';
						echo '</ul>';
					echo '</div>';
